...
import face from "../assets/elijah.jpg"

const Header = () => {
  return (
   <Wrapper>
     <div className='flex flex-col lg:flex-row bg-[#F5FCFF] gap-10 py-8'>
      <div className='bottom-24 top-28 lg:py-20 p-6'>
        ...
        <div className='bg-nav w-28 rounded-xl hover:border py-2 text-center mx-auto '>
        <button className=' text-[#FFFFFF]'>Get in Touch</button>
      </div>
      </div>
      <div>
